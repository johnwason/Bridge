    ...
    Bridge.define("Bridge.ClientTest.Batch4.SimpleTypes.DecimalTests", {
        methods: {
            ...
            DecimalToLong_SPI_1578: function () {
                ...
                // #1578
                Bridge.Test.NUnit.Assert.AreEqual(System.Int64([0,-5]), System.Decimal.toInt(x.sub(System.Decimal(21474836480.9, 1))));
                Bridge.Test.NUnit.Assert.AreEqual(System.Int64([-10,4]), System.Decimal.toInt(x.add(System.Decimal(21474836470.9, 1))));
            },
            DecimalToULong_SPI_1584_1585: function () {
                ...
                Bridge.ClientTest.Batch4.TestHelper.Safe(function () {
                    u3 = System.Decimal.toInt(x.sub(System.Decimal(0.9, 1)));
                });
                Bridge.Test.NUnit.Assert.AreEqual(System.UInt64(0), u3);

                var u4 = System.UInt64(0);
                Bridge.ClientTest.Batch4.TestHelper.Safe(function () {
                    u4 = System.Decimal.toInt(x.add(System.Decimal(42949672950.9, 1)));
                });
